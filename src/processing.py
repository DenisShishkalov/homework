...
# def sort_by_date(dictionary_list: list, date: int = 'date') -> list:
#     """ Функция сортировки операций по дате """
#     # sorted_dictionary_list = sorted(dictionary_list, key = 'date', reverse = False)
#
#     return dictionary_list.sort(key='date', reverse=False)
#
# print(sort_by_date(
#     [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
#      {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
